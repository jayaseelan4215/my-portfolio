  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at 70% 30%, ${theme === "dark"
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              >
                Frontend Developer • Scalable Web Solutions
              </p>
            </motion.div>
            ...
            <motion.p
              ...
              style={{ color: themeColors.summeryText }}
            >
              I combine aesthetics with engineering to craft web interfaces that are not only functional but also delightful to use.
            </motion.p>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-end">
            ...
            >
              <p
                ...
                style={{ color: themeColors.summeryText }}
              >
                Let’s stay connected! I share development notes, design experiments, and occasional bad jokes.
              </p>
          ...
          <div className="flex flex-col items-center lg:items-end">
            <motion.p
              ...
              style={{ color: themeColors.summeryText }}
            >
              Open to freelance work, consulting, or just a tech chat over coffee.
            </motion.p>
            <motion.a
              href="https://www.linkedin.com/in/jayaseelan-p-243562199/"
              target="_blank"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <motion.p
            ...
            style={{ color: themeColors.summeryText }}
          >
            © {new Date().getFullYear()} <a href="https://www.linkedin.com/in/jayaseelan-p-243562199/"><span style={{ color: themeColors.primaryColor }}>Jayaseelan</span></a> · Crafted with care and intention.
          </motion.p>
