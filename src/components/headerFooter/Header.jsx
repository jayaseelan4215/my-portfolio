    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
              className={`relative group py-2 transition-colors duration-300 ${activeLink === link.href ? "font-semibold" : "font-medium"
                }`}
              style={{
                color:
            ...
            >
              {link.name}
              <span
                className={`absolute bottom-0 left-0 h-0.5 transition-all duration-300 ${activeLink === link.href ? "w-full" : "w-0 group-hover:w-full"
                  }`}
        ...
        <div className="flex items-center gap-4">
          <a href="/jai_resume.pdf" target="_blank" rel="noopener noreferrer">
            <button
          ...
          <button
            ...
            style={{
              ...
              border: `1px solid ${mobileMenuOpen ? themeColors.primaryColor : themeColors.border
                }`,
            }}
